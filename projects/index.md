...
<section>
    ...
    <div class="posts">
        <article>
            <a href="{{ site.url }}/Intelligent-and-Learning-Agents/Mountain%20Car/" class="image"><img class="inversion" src="{{ site.url }}/Intelligent-and-Learning-Agents/Mountain%20Car/mountain-car.gif" alt="Mountain Car" /></a>
            <h3>Mountain Car</h3>
            ...
            <ul class="actions">
                <li><a href="{{ site.url }}/Intelligent-and-Learning-Agents/Mountain%20Car/" class="button">More</a></li>
            </ul>
        </article>
        <article>
            <a href="{{ site.url }}/Intelligent-and-Learning-Agents/Multi%20Armed%20Bandits/" class="image"><img src="{{ site.url }}/Intelligent-and-Learning-Agents/Multi%20Armed%20Bandits/multi-armed-bandit.gif" alt="Multi Armed Bandits" /></a>
            ...
            <ul class="actions">
                <li><a href="{{ site.url }}/Intelligent-and-Learning-Agents/Multi%20Armed%20Bandits/" class="button">More</a></li>
            </ul>
        </article>
        <article>
            <a href="{{ site.url }}/Intelligent-and-Learning-Agents/MDP%20Planning/" class="image"><img class="inversion" src="{{ site.url }}/Intelligent-and-Learning-Agents/MDP%20Planning/markov-decision-process.svg" alt="MDP Planning" /></a>
            <h3>MDP Planning</h3>
            <p>CS747 Intelligent and Learning Agents</p>
            ...
            <ul class="actions">
                <li><a href="{{ site.url }}/Intelligent-and-Learning-Agents/MDP%20Planning/" class="button">More</a></li>
            </ul>
        </article>
        <article>
            <a href="{{ site.url }}/Moustique-Cipher/" class="image"><img class="inversion" src="{{ site.url }}/Moustique-Cipher/stream-cipher.svg" alt="Moustique Cipher" /></a>
            ...
            <ul class="actions">
                <li><a href="{{ site.url }}/Moustique-Cipher/" class="button">More</a></li>
            </ul>
        </article>
        <article>
            <a href="{{ site.url }}/Microprocessors-Lab/EE337/Tennis/" class="image"><img src="{{ site.url }}/Microprocessors-Lab/EE337/Tennis/tennis-scoreboard-simulator.png" alt="Tennis Scoreboard Simulator" /></a>
            ...
            <ul class="actions">
                <li><a href="{{ site.url }}/Microprocessors-Lab/EE337/Tennis/" class="button">More</a></li>
            </ul>
        </article>
        <!-- <article>
        ...
        <article>
            <a href="{{ site.url }}/Digital-Circuits-Lab/Week%205/Music%20Synthesizer/" class="image"><img src="{{ site.url }}/Digital-Circuits-Lab/Week%205/Music%20Synthesizer/music-synthesizer.png" alt="Music Synthesizer" /></a>
            ...
            <ul class="actions">
                <li><a href="{{ site.url }}/Digital-Circuits-Lab/Week%205/Music%20Synthesizer/" class="button">More</a></li>
            </ul>
        </article>
    </div>
</section>
<section>
    ...
    <div class="posts">
        <article>
            <a href="distributed-deep-learning" class="image"><img src="{{ site.url }}/website-assets/distributed-deep-learning.jpg" alt="Distributed Deep Learning" /></a>
        ...
        <article>
            <a href="{{ site.url }}/Team-Rocket/" class="image"><img class="inversion" src="{{ site.url }}/website-assets/alu.svg" alt="Arithmetic Logic Unit" /></a>
            ...
            <ul class="actions">
                <li><a href="{{ site.url }}/Team-Rocket/" class="button">More</a></li>
            </ul>
        </article>
    </div>
</section>
<section>
    ...
    <div class="posts">
        <article>
            <a class="image"><img src="{{ site.url }}/website-assets/rc-plane.png" alt="" /></a>
        ...
        <article>
            <a class="image"><img src="{{ site.url }}/website-assets/rc-bot.png" alt="" /></a>
