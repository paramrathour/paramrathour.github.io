...
<section>
    ...
    <div class="posts">
        <article>
            <a href="Polynomial Roots" class="image"><iframe id="IFrame" title="Polynomial Roots" class="noinversion" src="Docs/Polynomial Roots.pdf" width="480" height="320"></iframe></a>
