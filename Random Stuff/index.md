...
<section>
    ...
    <div class="posts">
        <article>
            <a href="Polynomial Roots" class="image"><iframe id="inlineFrameExample" title="Inline Frame Example" class="noinversion" src="Docs/Polynomial Roots.pdf" width="500" height="320"></iframe></a>
